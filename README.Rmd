...
2. creates sequenced simulation files for each combination of arguments and creates a script file that can execute the simulation folder for the given DART process.
